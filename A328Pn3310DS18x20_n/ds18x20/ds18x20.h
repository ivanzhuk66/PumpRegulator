...
// For Strong parsite power With transistor MOSFET
#include <avr/interrupt.h>
#define DOINTERRUPT() sei()
#define NOINTERRUPT() cli()
#define DS_PWR_PIN PD5
#define DS_PWR_OUT  PORTD
#define DS_PWR_DDR  DDRD

#define DS_PWR_OUT_LOW()   DS_PWR_OUT &= (~(1 << DS_PWR_PIN)); _delay_loop_1(10) 
#define DS_PWR_OUT_HIGH()  DS_PWR_OUT |= (1 << DS_PWR_PIN)
#define DS_PWR_DIR_OUT()  ( DS_PWR_DDR |= (1 << DS_PWR_PIN) )
